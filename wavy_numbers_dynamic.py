    ...
    while True:
        ...
        while len(str(i)) < stopper:
            ...
            if len(str(i)) == stopper or len(str(i)) > stopper:
                ...
                block = "█" * len(str(i))
                dict_of_blocks[len(str(i))] = block
                wait()
                print(block)
                i = i * 2
        ...
        while i > 2:
            ...
            if i == 0 or i < 2:
                ...
                if len(str(i)) > stopper:
                    block = dict_of_blocks.get(len(str(i)) - 2)
                    wait()
                    print(block)
                    i = i // 2
                else:
    ...
    while True:
        ...
        while i > 2:
            ...
            if i == 0 or i < 2:
                ...
                if len(str(i)) > stopper:
                    i = int(dict_of_numbers.get(len(str(i)) - 2))
                    wait()
                    print(i)
                    i = i // 2
                else:
